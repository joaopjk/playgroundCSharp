...
public class PostAggregate : AggregateRoot
{
    ...
    public void EditMessage(string message)
    {
        ...
        if(string.IsNullOrWhiteSpace(message))
            throw new ArgumentNullException($"The {nameof(message)} cannot be null or empty.");
    ...
    public void AddComment(string comment, string username)
    {
        ...
        if(string.IsNullOrWhiteSpace(comment))
            throw new ArgumentNullException($"The {nameof(comment)} cannot be null or empty.");
        if(string.IsNullOrWhiteSpace(username))
            throw new ArgumentNullException($"The {nameof(username)} cannot be null or empty.");
    ...
    public void EditComment(Guid commentId, string comment, string username)
    {
        ...
        if(!_comments[commentId].Item1.Equals(username, StringComparison.OrdinalIgnoreCase))
